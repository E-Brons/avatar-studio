...
| D — Abbreviation + Programmatic Avatar (PA) | Initials PNG (PIL) + cartoon SVG (DiceBear / Node) |
...
# 2. Install Node.js vendor dependencies (Programmatic Avatar generator — DiceBear)
cd vendor/programmatic-avatar && npm ci && cd ../..
```
