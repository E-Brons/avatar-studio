...
EXPRESSION_OPTIONS: dict[str, dict[str, dict]] = {
    ...
    "bottts": {
        ...
        "sadness": {"eyes": ["happy"], "mouth": ["square02"]},
    ...
    "micah": {
        ...
        "anger": {"eyes": ["round"], "mouth": ["nervous"], "eyebrows": ["down"]},
        "sadness": {"eyes": ["eyesShadow"], "mouth": ["sad"], "eyebrows": ["eyelashesDown"]},
        "contempt": {"eyes": ["eyesShadow"], "mouth": ["smirk"], "eyebrows": ["eyelashesDown"]},
    },
    "opeeps": {
        ...
        "anger": {"eye": "Ellipse", "mouth": "Nervous", "eyebrow": "Down"},
        "sadness": {"eye": "EllipseShadow", "mouth": "Sad", "eyebrow": "Down"},
        "contempt": {"eye": "EllipseShadow", "mouth": "Smirk", "eyebrow": "EyelashesDown"},
    },
}
